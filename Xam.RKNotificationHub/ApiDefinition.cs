...
namespace Xam.RKNotificationHub
{
	[Static]
	//[Verify(ConstantsInterfaceAssociation)]
	interface Constants
	{
		// extern const CGFloat RKNotificationHubDefaultDiameter;
		[Field("RKNotificationHubDefaultDiameter", "__Internal")]
		nfloat RKNotificationHubDefaultDiameter { get; }

		// extern double RKNotificationHubVersionNumber;
		[Field("RKNotificationHubVersionNumber", "__Internal")]
		double RKNotificationHubVersionNumber { get; }

		// extern const unsigned char [] RKNotificationHubVersionString;
		[Field("RKNotificationHubVersionString", "__Internal")]
		IntPtr RKNotificationHubVersionString { get; }
	}
